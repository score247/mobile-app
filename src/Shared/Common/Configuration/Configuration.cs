namespace LiveScore.Common.Configuration
{
    ...
    {
#if DEBUG
        public static string LocalEndPoint => "https://score247-api1.nexdev.net/dev2/api/";

        public static string LocalHubEndPoint => "https://score247-api2.nexdev.net/dev2/hubs/";
#elif TEST
