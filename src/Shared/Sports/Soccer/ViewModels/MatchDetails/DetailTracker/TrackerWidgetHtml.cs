...
namespace LiveScore.Soccer.ViewModels.MatchDetails.DetailTracker
{
    public static class TrackerWidgetHtml
    {
        ...
        private static string GenerateFirstContent()
        {
            ...
            + "        </style>"
            + "    </head>"
            + "    <body style=\"background-color: #070915; padding: 0; margin: 0\">"
            + "        <script>"
        ...
        private static string GenerateSecondContent()
            ...
            + "});"
            + "SIR(\"addWidget\", \".sr-widget\", \"match.lmtPlus\", { adsFrequency:false, scoreboard: \"disable\", detailedScoreboard: \"disable\", tabsPosition: \"disable\", matchId:'input-match-id'});"
            + "        </script>"
            + "        <div class=\"widgets\">"
            + "            <div class=\"sr-widget\" data-sr-widget='match.lmtPlus' data-sr-match-id='input-match-id'></div>			"
            + "        </div>"
            + "    </body>"
            + "</html>";
    }
